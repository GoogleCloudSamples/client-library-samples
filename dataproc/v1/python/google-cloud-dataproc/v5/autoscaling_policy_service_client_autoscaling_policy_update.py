...
# [START dataproc_v1_autoscalingpolicyservice_autoscalingpolicy_update]
import sys
...
def update_autoscaling_policy(project_id: str, location: str, policy_id: str) -> None:
    ...
    updated_policy = dataproc_v1.AutoscalingPolicy(
        ...
        labels={"environment": "production", "updated_by": "example-code"},
    )
    ...
    try:
        ...
        print(f"Error updating autoscaling policy: {e}", file=sys.stderr)
    except Exception as e:
        print(f"An unexpected error occurred: {e}", file=sys.stderr)


# [END dataproc_v1_autoscalingpolicyservice_autoscalingpolicy_update]
