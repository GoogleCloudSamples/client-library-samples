...
# [START documentai_v1_documentprocessor_processortypes_list_full]
import sys
...
def list_processor_types_full(
    ...
    Lists the processor types available for a given project and location with pagination support.
...
# [END documentai_v1_documentprocessor_processortypes_list_full]
