...
# [START documentai_v1beta3_documentprocessor_evaluations_list_full]
import sys
...
def list_evaluations_full(
    ...
    Lists the evaluations for a specific processor version with pagination support.
    ...
    Args:
        ...
        page_size: The maximum number of evaluations to return.
    """
...
# [END documentai_v1beta3_documentprocessor_evaluations_list_full]
