...
# [START documentai_v1beta3_documentprocessor_processorversions_list]
import sys
...
def list_processor_versions(
    ...
    Lists the versions of a specific processor.
...
# [END documentai_v1beta3_documentprocessor_processorversions_list]
