...
# [START documentai_v1beta3_documentprocessor_processors_list_full]
import sys
...
def list_processors_full(
    ...
    Lists the processors created with pagination support.
...
# [END documentai_v1beta3_documentprocessor_processors_list_full]
