...
# [START documentai_v1beta3_documentprocessor_processors_list]
import sys
...
def list_processors(
    ...
    Lists the processors created in a project and location.
...
# [END documentai_v1beta3_documentprocessor_processors_list]
