...
# [START documentai_v1beta3_document_datasetschema_get]
import sys
...
def get_dataset_schema(
    ...
    try:
        ...
        for entity_type in response.document_schema.entity_types:
            print(f"Entity Type: {entity_type.base_types}")
...
# [END documentai_v1beta3_document_datasetschema_get]
