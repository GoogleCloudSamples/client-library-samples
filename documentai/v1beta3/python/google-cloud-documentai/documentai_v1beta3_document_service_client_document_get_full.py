...
# [START documentai_v1beta3_document_get_full]
import sys
...
def get_document_full(
    ...
    Retrieves a document from a dataset with detailed configuration.
    ...
    try:
        ...
        print(f"Document Text: {response.document.text[:50]}...")
...
# [END documentai_v1beta3_document_get_full]
