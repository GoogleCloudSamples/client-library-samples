...
# [START retail_v2alpha_product_get]
...
def get_product(
    ...
    Args:
        ...
        location: The location of the catalog. "global" is the only valid value.
        catalog_id: The ID of the catalog.
        branch_id: The ID of the branch. "default_branch" is the default value.
    ...
    try:
        ...
        print(f"  Availability: {product.availability.name}")
...
# [END retail_v2alpha_product_get]
