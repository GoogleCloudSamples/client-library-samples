...
def delete_folder_sample(
    ...
    try:
        ...
        print("Please ensure the folder path is correct and exists in the specified bucket.")
...
if __name__ == "__main__":
    ...
    delete_folder_sample(args.bucket_name, args.folder_name)
