...
def get_storage_layout_sample(
    ...
    try:
        ...
        if response.hierarchical_namespace:
            print(f"Hierarchical Namespace Enabled: {response.hierarchical_namespace.enabled}")
        else:
        ...
        print(f"Error: StorageLayout for bucket '{bucket_name}' not found. "
